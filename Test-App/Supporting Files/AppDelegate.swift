...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    // MARK: - Auto Login and check if we have local user
    func autoLogin() {
    ...
    private func setupUIConfiguration() {
        ...
        // default color for tapbar and UINavigationBar
        
        // TabBar
        UITabBar.appearance().shadowImage = UIImage()
        UITabBar.appearance().backgroundImage = UIImage()
        UITabBar.appearance().backgroundColor = UIColor().primaryColor()
        UITabBar.appearance().unselectedItemTintColor = UIColor().tabBarSelectedColor()
